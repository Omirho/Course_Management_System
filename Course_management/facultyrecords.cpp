...
namespace Course_management
{
	...
	Void facultyrecords::facultyrecords_Load(System::Object^  sender, System::EventArgs^  e)
	{
		...
		MySqlCommand^ cmdDataBase=gcnew MySqlCommand("SELECT name,username,password,department FROM course_management.faculty_list;",conDataBase);
